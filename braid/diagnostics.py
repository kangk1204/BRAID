...
class DiagnosticsCollector:
    ...
    def __init__(self, output_dir: str | Path) -> None:
        ...
        # When set, the summary is flagged incomplete (e.g. parallel workers do not
        # aggregate per-chromosome diagnostics) so machine readers do not mistake an
        # un-collected count for a genuine zero.
        self.incomplete_note: str | None = None
    ...
    def _build_summary(
        ...
        summary: dict[str, Any] = {
            "complete": self.incomplete_note is None,
        ...
        if self.incomplete_note is not None:
            summary["note"] = self.incomplete_note
        return summary
