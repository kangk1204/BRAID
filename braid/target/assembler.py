...
from braid.core.bootstrap_engine import DecomposeConfig
from braid.core.bootstrap_enginer import run_decomposer_pair
from braid.core.builder import GraphBuilderConfig, SpliceGraphBuilder
from braid.io.bam_reader import BamReader, extract_junctions_from_bam
from braid.io.reference import ReferenceGenome
from braid.core.features import extract_features, features_to_array
from braid.core.filter import FilterConfig, TranscriptFilter
from braid.core.model import TranscriptScorer
from braid.target.extractor import ExtractionStats, TargetRegion
...
def assemble_target(config: TargetConfig) -> TargetAssemblyResult:
    ...
    from braid.core.builder import LocusDefinition
