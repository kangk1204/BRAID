...
algorithmic structure is mirrored in the CUDA kernels (see ``braid.cuda``).
...
def _push_relabel_numba(
    ...
    flow_value = float(excess[sink]) if converged else float("nan")
