...
CORE_PACKAGE_SPECS: list[dict[str, Any]] = [
    {
        ...
        "module": "braid",
        "distribution": "braid",
        "distribution_fallbacks": ["braid"],
        "note": "legacy module path: braid",
    },
...
BENCHMARK_PACKAGE_SPECS: list[dict[str, Any]] = [
    {
        ...
        "note": "optional coordinate liftover for a legacy benchmark; not used by the "
        "documented rMATS-first workflow or the paper analyses",
    },
]
...
OPTIONAL_COMMAND_SPECS: list[dict[str, Any]] = [
    {
        "label": "git",
        "command": "git",
        "note": "needed to download BRAID from GitHub for a source install",
    },
    {"label": "samtools", "command": "samtools", "note": "BAM indexing for benchmark prep"},
    {"label": "hisat2", "command": "hisat2", "note": "read alignment for benchmark prep"},
    {
        "label": "rmats.py",
        "command": "rmats.py",
        "note": "upstream rMATS that produces the event tables BRAID post-processes",
    },
]
