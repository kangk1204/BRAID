...
from braid.cuda.backend import get_array_module, get_backend, to_device, to_host
from braid.cuda.kernels import parallel_coverage_scan
from braid.graph.splice_graph import BatchedCSRGraphs, CSRGraph
...
class BatchProcessor:
    ...
    def process_coverage_batch(
        ...
        returned by :class:`braid.io.bam_reader.ReadData`.
