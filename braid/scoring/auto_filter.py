...
from braid.scoring.filter import FilterConfig, _intron_chain_key
...
def evaluate_filter_config(
    ...
    """
    from braid.scoring.filter import TranscriptFilter
    ...
    if reference_exon_chains is not None:
        ...
        for idx in surviving:
            chain = _intron_chain_key(transcripts[idx])
